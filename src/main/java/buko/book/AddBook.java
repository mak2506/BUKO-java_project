...
public class AddBook extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String strinsert="insert into book_details (book_name, author, genre, price, description, file, image, book_isbn, user_id, publishdate, status, language) values (?,?,?,?,?,?,?,?, ?, ?, 'pending', ?)";
		 ...
		 try {	
			 ...
			 if(status>0) {
					...
					fos2.close();
				 	...
				 	response.sendRedirect("/buko/add");
